    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content">
            ...
            $enrollment = $_REQUEST['enrollment'];
             ...
             $selectStudent = "SELECT * FROM `student` WHERE `enrollment` = '$enrollment'";
            
            $resultStudent = mysqli_query($db->db_connect(),$selectStudent); 
           
             while($row =  mysqli_fetch_row($resultStudent)){
                $studentId=$row[0];
            }
            
            
            
             $selectQuery = "SELECT * FROM `attendance` WHERE  `semster`='$semester' AND `department_id`='$depID' AND `student_id`=$studentId";
